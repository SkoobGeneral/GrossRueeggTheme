<template>
  <div class="icon-wrapper">
    <svg :style="{width: `${iconwidth}`, height: `${iconheight}`}" viewBox='0 0 34 34' v-if="icon === 'arrow-left'">
      <path :fill="color" d="M10.273,5.009c0.444-0.444,1.143-0.444,1.587,0c0.429,0.429,0.429,1.143,0,1.571l-8.047,8.047h26.554
