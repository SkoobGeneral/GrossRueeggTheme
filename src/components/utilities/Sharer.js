...
export function shareOnGooglePlus (urlParams, text, via, title) {
  var shareUrl = `${window.location.origin}${window.location.pathname}`
  const shareServiceUrl = "https://plus.google.com/share"
  var newText = stripTags(text)
  if (urlParams) {
    shareUrl += "?" + urlParams
  }
...
export function shareOnInstagram (urlParams, text, via, title) {
  var shareUrl = `${window.location.origin}${window.location.pathname}`
  const shareServiceUrl = "http://www.instagram.com/"
  var newText = stripTags(text)
  if (urlParams) {
    shareUrl += "?" + urlParams
  }
